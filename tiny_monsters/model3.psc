...
!F a_check = piecewise(1,ge(ATP,2700),0)
!F b_check = piecewise(1,ge(ATP,1560),0)
!F d_check = piecewise(1,ge(ATP,2700),0)
!F z_check = piecewise(1,ge(ATP,1560),0)
...
X_activates_P:
    ...
    0.113782138475 * X_protein * P_basal_promoter
X_unactivates_P:
